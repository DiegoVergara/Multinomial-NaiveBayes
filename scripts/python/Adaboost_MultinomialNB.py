...
"""
d_train=np.loadtxt('../../data/adience/dataset.csv',delimiter=',')
d_train_label=np.loadtxt('../../data/adience/gender_label.csv',delimiter=',')
...
for train_index, test_index in kf:
    ...
    for estimators in v_n_estimators:
        ...
        ada_mnb=adaboost_mnb(X_train, Y_train, X_test, estimators, learning_rate, alpha)
        ada_mnb.fit()
        Y_hat = ada_mnb.predict()
